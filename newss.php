<?php include('components/head.inc.php'); ?>
    ...
    <link rel="stylesheet" href="news/assets/css/owl.carousel.min.css">
    <link rel="stylesheet" href="news/assets/css/ticker-style.css">
    <link rel="stylesheet" href="news/assets/css/flaticon.css">
    <link rel="stylesheet" href="news/assets/css/slicknav.css">
    <link rel="stylesheet" href="news/assets/css/animate.min.css">
    <link rel="stylesheet" href="news/assets/css/magnific-popup.css">
    <link rel="stylesheet" href="news/assets/css/fontawesome-all.min.css">
    <link rel="stylesheet" href="news/assets/css/themify-icons.css">
    <link rel="stylesheet" href="news/assets/css/slick.css">
    <link rel="stylesheet" href="news/assets/css/nice-select.css">
    ...
    <div class="preloader d-flex align-items-center justify-content-center">
        <div class="preloader-inner position-relative">
            ...
            <div class="preloader-img pere-text">
                <img src="news/assets/img/logo/logo.png" alt="">
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="slider-active">
                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="news/assets/img/trending/trending_top2.jpg" alt="">
                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="news/assets/img/trending/trending_top02.jpg" alt="">
                                        <div class="trend-top-cap">
                                            <span class="bgr" data-animation="fadeInUp" data-delay=".2s" data-duration="1000ms">Business</span>
                                            <h2><a href="latest_news.html" data-animation="fadeInUp" data-delay=".4s" data-duration="1000ms">Anna Lora Stuns In White At Her Australian Premiere</a></h2>
                                            <p data-animation="fadeInUp" data-delay=".6s" data-duration="1000ms">by Alice cloe   -   Jun 19, 2020</p>
                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="news/assets/img/trending/trending_top03.jpg" alt="">
                                        <div class="trend-top-cap">
                                            <span class="bgr" data-animation="fadeInUp" data-delay=".2s" data-duration="1000ms">Business</span>
                                            <h2><a href="latest_news.html" data-animation="fadeInUp" data-delay=".4s" data-duration="1000ms">Anna Lora Stuns In White At Her Australian Premiere</a></h2>
                                            <p data-animation="fadeInUp" data-delay=".6s" data-duration="1000ms">by Alice cloe   -   Jun 19, 2020</p>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="news/assets/img/trending/trending_top3.jpg" alt="">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="news/assets/img/trending/trending_top4.jpg" alt="">
                                        <div class="trend-top-cap trend-top-cap2">
